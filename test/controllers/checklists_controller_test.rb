...
class ChecklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checklist" do
    assert_difference('Checklist.count') do
      post checklists_url, params: { checklist: { email: @checklist.email, number: @checklist.number } }
    end
  ...
  test "should update checklist" do
    patch checklist_url(@checklist), params: { checklist: { email: @checklist.email, number: @checklist.number } }
